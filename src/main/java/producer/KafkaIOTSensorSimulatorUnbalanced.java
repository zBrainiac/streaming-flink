 ...
 *   java -classpath streaming-flink-0.2-SNAPSHOT.jar producer.KafkaIOTSensorSimulatorUnbalanced localhost:9092
 *
 * @author Marcel Daeppen
 * @version 2020/08/28 12:14
 */

public class KafkaIOTSensorSimulatorUnbalanced<WeightedRandomBag> {
    ...
    private static void publishMessage(Producer<String, byte[]> producer) throws Exception {
        ...
        System.err.println("partition: " + md.partition());
    }
