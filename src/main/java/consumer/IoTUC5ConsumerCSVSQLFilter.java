 ...
 *    ./bin/flink run -m yarn-cluster -c consumer.IoTUC5ConsumerCSVSQLFilter -ynm IoTUC5ConsumerCSVSQLFilter lib/flink/examples/streaming/streaming-flink-0.4.1.0.jar localhost:9092
 ...
 *
 *    java -classpath streaming-flink-0.4.1.0.jar consumer.IoTUC5ConsumerCSVSQLFilter
 *
