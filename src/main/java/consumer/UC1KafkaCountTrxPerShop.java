 ...
 *    ./bin/flink run -m yarn-cluster -c consumer.UC1KafkaCountTrxPerShop -ynm UC1KafkaCountTrxPerShop lib/flink/examples/streaming/streaming-flink-0.2-SNAPSHOT.jar localhost:9092
 *
 *    java -classpath streaming-flink-0.2-SNAPSHOT.jar consumer.UC1KafkaCountTrxPerShop
 *
