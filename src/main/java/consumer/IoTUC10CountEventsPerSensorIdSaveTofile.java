 ...
 *    ./bin/flink run -m yarn-cluster -c consumer.IoTUC10CountEventsPerSensorIdSaveTofile -ynm IoTUC10CountEventsPerSensorIdSaveTofile lib/flink/examples/streaming/streaming-flink-0.5.0.0.jar localhost:9092
 *
 *    java -classpath streaming-flink-0.5.0.0.jar consumer.IoTUC10CountEventsPerSensorIdSaveTofile
 *
...
public class IoTUC10CountEventsPerSensorIdSaveTofile {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String usecaseid = "IoTUC10CountEventsPerSensorIdSaveTofile";
        ...
        StreamingFileSink<Tuple15<Long, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>> sinkfile = StreamingFileSink
                .forRowFormat(new Path(outputFolder), new SimpleStringEncoder<Tuple15<Long, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>>("UTF-8"))
                .withRollingPolicy(
        ...
        transformedStream.addSink(sinkfile);
