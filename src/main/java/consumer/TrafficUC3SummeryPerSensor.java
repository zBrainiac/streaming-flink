 ...
 * ./bin/flink run -m yarn-cluster -c consumer.TrafficUC3SummeryPerSensor -ynm TrafficUC3SummeryPerSensor lib/flink/examples/streaming/streaming-flink-0.3.1.0.jar localhost:9092
 ...
 *
 * java -classpath streaming-flink-0.3.1.0.jar consumer.TrafficUC3SummeryPerSensor
 *
