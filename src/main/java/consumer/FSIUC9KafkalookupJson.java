 ...
 *    ./bin/flink run -m yarn-cluster -c consumer.FSIUC9KafkalookupJson -ynm FSIUC9KafkalookupJson lib/flink/examples/streaming/streaming-flink-0.4.1.0.jar localhost:9092
 *    ./bin/flink run -m yarn-cluster -c consumer.FSIUC9KafkalookupJson -ynm FSIUC9KafkalookupJson lib/flink/examples/streaming/streaming-flink-0.4.1.0.jar edge2ai-1.dim.local:9092 /tmp/lookupHeader.csv
 *    java -classpath streaming-flink-0.4.1.0.jar consumer.FSIUC9KafkalookupJson edge2ai-1.dim.local:9092
 *
