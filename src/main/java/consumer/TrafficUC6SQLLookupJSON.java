 ...
 *    ./bin/flink run -m yarn-cluster -c consumer.TrafficUC6SQLLookupJSON -ynm TrafficUC6SQLLookupJSON lib/flink/examples/streaming/streaming-flink-0.3.0.1.jar edge2ai-1.dim.local:9092 /tmp/lookup.csv
