 ...
 *   ./bin/flink run -m yarn-cluster -c consumer.TrafficUC5Join -ynm TrafficUC5Join lib/flink/examples/streaming/streaming-flink-0.4.1.0.jar localhost:9092
 ...
 *   java -classpath streaming-flink-0.4.1.0.jar consumer.TrafficUC5Join
 *
