 ...
 * ./bin/flink run -m yarn-cluster -c consumer.TrafficUC2WindowSensorTyp -ynm TrafficUC2WindowSensorTyp lib/flink/examples/streaming/streaming-flink-0.4.0.0.jar localhost:9092
 ...
 *
 * java -classpath streaming-flink-0.4.0.0.jar consumer.TrafficUC2WindowSensorTyp
 *
