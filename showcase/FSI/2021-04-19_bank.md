...
### Upload release:
```
scp -i field.pem GoogleDrive/workspace/streaming-flink/target/streaming-flink-0.4.1.0.jar centos@18.192.239.205:/tmp  
...
cd /opt/cloudera/parcels/FLINK/lib/flink/examples/streaming &&
java -classpath streaming-flink-0.4.1.0.jar producer.KafkaFSICreditCartTRX edge2ai-1.dim.local:9092 333
```
