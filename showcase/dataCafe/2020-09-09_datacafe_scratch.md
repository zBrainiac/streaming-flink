...
sudo wget https://github.com/zBrainiac/streaming-flink/releases/download/0.2.5.3/streaming-flink-0.4.0.0.jar -P /opt/cloudera/parcels/FLINK/lib/flink/examples/streaming


cd /opt/cloudera/parcels/FLINK/lib/flink/examples/streaming  
java -classpath streaming-flink-0.4.0.0.jar producer.KafkaProducerUnbalanced edge2ai-1.dim.local:9092
java -classpath streaming-flink-0.4.0.0.jar producer.KafkaProducerSimple edge2ai-1.dim.local:9092
