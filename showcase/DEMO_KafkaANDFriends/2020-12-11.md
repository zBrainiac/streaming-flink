...
./bin/flink run -m yarn-cluster -c consumer.IoTUC9SQLLookupJSON -ynm IoTSQLLookupJSON lib/flink/examples/streaming/streaming-flink-0.4.1.0.jar edge2ai-1.dim.local:9092 /tmp/lookup.csv
```